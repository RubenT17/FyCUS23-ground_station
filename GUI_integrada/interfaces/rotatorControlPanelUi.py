...
class Ui_rotatorControlPanel(object):
    def setupUi(self, rotatorControlPanel):
        ...
        self.menuReload = QtWidgets.QMenu(self.menuBar)
        ...
        self.actReload = QtWidgets.QAction(rotatorControlPanel)
        self.actReload.setObjectName("actReload")
        ...
        self.menuReload.addAction(self.actReload)
    ...
    def retranslateUi(self, rotatorControlPanel):
        ...
        self.menuReload.setTitle(_translate("rotatorControlPanel", "Application"))
        ...
        self.actReload.setText(_translate("rotatorControlPanel", "Reload"))
